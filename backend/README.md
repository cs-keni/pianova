...
media preparation, typed transcription orchestration, and deterministic symbolic timing. Basic Pitch and
...
and `POST /api/projects/{project_id}/quantize`. Interactive OpenAPI documentation is available at
